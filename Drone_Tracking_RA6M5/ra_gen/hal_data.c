...
#include "hal_data.h"
iwdt_instance_ctrl_t g_iwdt0_ctrl;

const wdt_cfg_t g_iwdt0_cfg =
...
const wdt_instance_t g_iwdt0 =
{ .p_ctrl = &g_iwdt0_ctrl, .p_cfg = &g_iwdt0_cfg, .p_api = &g_wdt_on_iwdt };
...
baud_setting_t g_uart2_baud_setting =
        ...
        /* Baud rate calculated with 1.725% error. */.semr_baudrate_bits_b.abcse = 0,
          .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 23, .mddr = (uint8_t) 256, .semr_baudrate_bits_b.brme =
                  false };
...
#undef RA_NOT_DEFINED
  .rxi_ipl = (10),
  .txi_ipl = (10), .tei_ipl = (10), .eri_ipl = (10),
...
baud_setting_t g_uart5_baud_setting =
        {
        /* Baud rate calculated with 0.309% error. */.semr_baudrate_bits_b.abcse = 0,
          .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 5, .mddr = (uint8_t) 245, .semr_baudrate_bits_b.brme =
                  true };
...
#undef RA_NOT_DEFINED
  .rxi_ipl = (11),
  .txi_ipl = (11), .tei_ipl = (11), .eri_ipl = (11),
